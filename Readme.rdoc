...
*Note:* The Saturday project has been merged into {days_picker}[https://rubygems.org/gems/days_picker] project kindly refer to {days_picker}[https://rubygems.org/gems/days_picker] .
